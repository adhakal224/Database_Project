...
--Query 2 (Aayush)
Select goal_id, goal_name, description, user_fname, user_lname from Goals natural join User where Goals.user_Id = (SELECT user_id from User where user_fname='Aayush' and user_lname='Dhakal');
